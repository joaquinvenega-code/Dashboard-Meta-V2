...
// Run after npm run build: npx tsx scripts/render-report-fixture.tsx [messaging|ecommerce|empty|long]
...
if (!['messaging', 'ecommerce', 'empty', 'long'].includes(variant)) throw new Error('Unknown fixture');
