...
export function formatCurrency(value: number, currency: string = 'ARS', decimals: number = 0) {
  ...
  return sym + new Intl.NumberFormat('es-AR', { minimumFractionDigits: decimals, maximumFractionDigits: decimals }).format(val);
}
