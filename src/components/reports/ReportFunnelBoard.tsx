  ...
  return (
    <div className="w-full flex items-center gap-4 h-full py-2">
      ...
      <div className="w-[180px] md:w-[200px] flex flex-col items-center justify-center shrink-0" style={{ gap: '2px' }}>
        <div 
          className="w-full h-[68px] bg-blue-300 print:bg-blue-300 shadow-xl flex items-center justify-center relative overflow-hidden"
        ...
        <div 
          className="w-[86%] h-[68px] bg-blue-500 print:bg-blue-500 shadow-lg flex items-center justify-center relative overflow-hidden"
        ...
        >
          ...
          <div className="flex flex-col items-center relative z-10">
             <span className="text-[7px] font-black text-white/60 print:text-white/60 uppercase tracking-[0.2em]">VISITA A PÁGINA</span>
             <span className="text-[12px] font-black text-white print:text-white tracking-tight">{formatDecimal(pageViews, 0)}</span>
          </div>
        </div>
        <div 
          className="w-[78%] h-[68px] bg-blue-700 print:bg-blue-700 shadow-xl flex items-center justify-center relative overflow-hidden"
          style={{ clipPath: 'polygon(9% 0%, 91% 0%, 84% 100%, 16% 100%)' }}
        >
          <div className="absolute inset-0 bg-gradient-to-b from-white/10 to-transparent print:hidden" />
          <div className="flex flex-col items-center relative z-10">
             <span className="text-[7px] font-black text-white/60 print:text-white/60 uppercase tracking-[0.1em] text-center">AGREGADOS AL CARRITO</span>
             <span className="text-[12px] font-black text-white print:text-white tracking-tight">{formatDecimal(atc, 0)}</span>
          </div>
        </div>
        <div 
          className="w-[69%] h-[68px] bg-blue-900 print:bg-blue-900 shadow-2xl flex items-center justify-center relative overflow-hidden"
          style={{ clipPath: 'polygon(14% 0%, 86% 0%, 80% 100%, 20% 100%)' }}
        >
          <div className="absolute inset-0 bg-gradient-to-b from-white/10 to-transparent print:hidden" />
          <div className="flex flex-col items-center relative z-10">
             <span className="text-[7px] font-black text-white/60 print:text-white/60 uppercase tracking-[0.2em]">COMPRAS</span>
             <span className="text-[12px] font-black text-white print:text-white tracking-tight">{formatDecimal(purchases, 0)}</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center min-w-0 shrink-0" style={{ gap: '2px' }}>
        {/* Tasa de Clics (CTR) */}
        <div className="h-[68px] bg-blue-300 print:bg-blue-300 rounded-r-[1.5rem] rounded-l-md px-3 flex items-center justify-between text-blue-950 shadow-lg relative overflow-hidden">
        ...
        <div className="h-[68px] bg-blue-500 print:bg-blue-500 rounded-r-[1.5rem] rounded-l-md px-3 flex items-center justify-between text-white print:text-white shadow-md relative overflow-hidden">
        ...
        <div className="h-[68px] bg-blue-700 print:bg-blue-700 rounded-r-[1.5rem] rounded-l-md px-3 flex items-center justify-between text-white print:text-white shadow-lg relative overflow-hidden">
        ...
        <div className="h-[68px] bg-blue-900 print:bg-blue-900 rounded-r-[1.5rem] rounded-l-md px-3 flex items-center justify-between text-white print:text-white shadow-2xl relative overflow-hidden">
