  ...
  return (
    <div className="w-full flex items-center gap-4 h-full py-2">
      ...
      <div className="w-[180px] md:w-[200px] flex flex-col items-center justify-center shrink-0" style={{ gap: '2px' }}>
        ...
        <div 
          className="w-[78%] h-[68px] bg-blue-700 shadow-xl flex items-center justify-center relative overflow-hidden print:border print:border-blue-700"
        ...
        <div 
          className="w-[69%] h-[68px] bg-blue-900 shadow-2xl flex items-center justify-center relative overflow-hidden print:border print:border-blue-900"
      ...
      <div className="flex-1 flex flex-col justify-center min-w-0 shrink-0" style={{ gap: '2px' }}>
        {/* Tasa de Clics (CTR) */}
        <div className="h-[68px] bg-blue-300 print:bg-blue-300 rounded-r-[1.5rem] rounded-l-md px-3 flex items-center justify-between text-blue-950 shadow-lg relative overflow-hidden border border-blue-400/30 print:border-blue-400">
          ...
          <div className="relative z-10 text-[8px] font-bold opacity-30 uppercase tracking-[0.2em] ml-2 text-right shrink-0 print:hidden">CTR</div>
        </div>

        {/* Tasa de Visita a Página */}
        <div className="h-[68px] bg-blue-500 rounded-r-[1.5rem] rounded-l-md px-3 flex items-center justify-between text-white shadow-md relative overflow-hidden print:border print:border-blue-500">
          ...
          <div className="relative z-10 text-[8px] font-bold opacity-30 uppercase tracking-[0.1em] ml-2 text-right leading-tight shrink-0 print:hidden">TASA<br/>VISITA</div>
        </div>

        {/* Tasa de Agregado al Carrito */}
        <div className="h-[68px] bg-blue-700 rounded-r-[1.5rem] rounded-l-md px-3 flex items-center justify-between text-white shadow-lg relative overflow-hidden print:border print:border-blue-700">
          ...
          <div className="relative z-10 text-[8px] font-bold opacity-30 uppercase tracking-[0.2em] ml-2 text-right leading-tight shrink-0 print:hidden">TASA<br/>ATC</div>
        </div>

        {/* Tasa de Compras (Conversion Rate) */}
        <div className="h-[68px] bg-blue-900 rounded-r-[1.5rem] rounded-l-md px-3 flex items-center justify-between text-white shadow-2xl relative overflow-hidden print:border print:border-blue-900">
          ...
          <div className="relative z-10 text-[8px] font-bold opacity-30 uppercase tracking-[0.2em] ml-2 text-right shrink-0 print:hidden">CONV.</div>
        </div>
      </div>
    </div>
  );
